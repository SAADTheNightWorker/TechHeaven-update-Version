...
const navigate = useNavigate()
  ...
  return (
    <>
    {basket.length === 0 ?   <img className="w-full h-80 object-cover" src={page}/>  : "" }
      ...
      >
        <h1 className="text-xl font-semibold font-sora text-accent ml-4">{basket.length === 0 ? "( No item )" : `Cart`}</h1>
        ...
        <div className="flex-[.2] w-44 border-l-2 mr-3 p-10 mt-10 h-[66vh] ">
